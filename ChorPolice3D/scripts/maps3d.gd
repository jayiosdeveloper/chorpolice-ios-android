...
static func _dustline() -> Dictionary:
	var l := {
		...
		"houses": [
			...
			_h(66, 60, 0.0, {"w": 4, "d": 6, "floors": 1, "open": true, "doors": [["W", 0], ["E", 5], ["N", 1]], "windows": [["E", 1, 0], ["E", 3, 0], ["W", 2, 0], ["W", 4, 0], ["N", 3, 0], ["S", 0, 0], ["S", 3, 0]], "stairs": null, "roof": "flat", "roof_stairs": false, "seed": 97}, "whitewash"),
